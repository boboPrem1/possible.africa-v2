    ...
    <div className="flex justify-center">
      <div className="flex flex-col w-11/12">
        ...
        <div className="w-full flex justify-between px-5">
          <div className="w-8/12 flex flex-col justify-center p-5 rounded-xl shadow-xl">
          ...
          <div className="bg-yellow-500 h-16 w-3/12 p-5 rounded-xl shadow-xl"></div>
        </div>
      </div>
    </div>
  );
...
const New = () => {
  return (
    <div className="flex justify-between items-center gap-x-5 border border-gray-light-300 bg-primary-50 rounded-md min-h-26 p-2.5 min-w-full">
