...
import { ResponsiveCloropleth } from "../components/for_database/donut_chart";
      ...
      <div className="flex flex-col w-11/12">
        ...
        <div className="flex flex-col gap-y-5 relative">
          <GrowingEnterAnimation>
            <div className="w-full bg-custom-white rounded-2xl p-6">
              <div className="flex flex-col justify-center">
                <div className="grid grid-cols-3 grid-rows-2 gap-x-11 gap-y-10">
          ...
          <GrowingEnterAnimation className=" w-full">
            <div className="w-full rounded-2xl grid grid-cols-4 gap-x-4">
              ...
              <div className="col-span-2 h-[500px] w-full bg-custom-white rounded-2xl">
